...
try:
   credencial_ = {
      ...
      "prod":[
         {
         "USERNAME":os.environ("USERNAME_PRODUCAO"),
         "PASSWORD":os.environ("PASSWORD_PRODUCAO"),
         "HOSTNAME":os.environ("HOSTNAME_PRODUCAO"),
         "PORT":os.environ("PORT_PRODUCAO"),
         "DATABASE":os.environ("DATABASE_PRODUCAO")
      }
   ]
   }
   ...
   credencial_ = {
      ...
      "prod":[
         {
         "USERNAME":os.getenv("USERNAME_PRODUCAO"),
         "PASSWORD":os.getenv("PASSWORD_PRODUCAO"),
         "HOSTNAME":os.getenv("HOSTNAME_PRODUCAO"),
         "PORT":os.getenv("PORT_PRODUCAO"),
         "DATABASE":os.getenv("DATABASE_PRODUCAO")
      }
   ]
   }
