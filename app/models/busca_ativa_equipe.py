...
class Gestantes(Base):
    ...
    gestante_idade_gestacional_primeiro_atendimento = Column(
    ...
    gestante_consulta_prenatal_ultima_dias_desde = Column(
        Integer, nullable=True
    )
    atendimento_odontologico_realizado = Column(String, nullable=True)
    atendimento_odontologico_realizado_identificacao = Column(
