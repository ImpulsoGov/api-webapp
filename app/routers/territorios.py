...
async def busca_domicilios(
    ibge: Optional[str] = None, id: Optional[str] = None
):
...
async def busca_individuos(
    ibge: Optional[str] = None, domicilio_id: Optional[str] = None
):
